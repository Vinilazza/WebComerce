...
<head>
    ...
    <title>VLTECH | Os melhores preços!</title>
...
<div class="logo">
    ...
    <form class="form_container" action="efetuar_login.php" method="POST">
        ...
        <div class="input_container">
            ...
            <input placeholder="nome" title="Inpit title" name="nome" type="text" class="input_field" id="email_field">
        </div>
        <div class="input_container">

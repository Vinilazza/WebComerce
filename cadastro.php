...
if (isset($_POST['create'])) {
    ...
    $clienteDAO->cadastrarUsuarioInterno($nome,$email,$senha);
...
<body>
    ...
    <form class="form_container" method="POST">
        ...
        <div class="input_container">
            <label class="input_label" for="nome">Nome</label>
            ...
            <input placeholder="Nome / Sobrenome" title="Inpit title" name="nome" type="text" class="input_field" id="nome">
        </div>
        <div class="input_container">
        ...
        <button title="Sign In" type="submit" name="create" class="sign-in_btn">

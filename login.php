    ...
    <div class="d-flex justify-content-center">
        <form class="form_container" method="POST">
            ...
            <div class="title_container">
                ...
                <span class="subtitle">Voce ainda não possui uma conta? <a href="/cadastro.php" class="text-decoration-none">Cadastrar</a></span>
            </div>
            <br>
            ...
            <a href="<?= htmlspecialchars($loginUrl) ?>" class="sign-in_ggl text-decoration-none">
                ...
                <span><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" class="me-1" height="20" viewBox="0 0 48 48">

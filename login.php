...
<body>
    ...
    <form class="form_container">
        ...
        <div class="input_container">
            ...
            <input placeholder="email@gmail.com" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field">
        </div>
        <div class="input_container">
            ...
            <input placeholder="Senha" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field">
        </div>
